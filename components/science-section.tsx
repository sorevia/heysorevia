...
import { Dumbbell, FlaskConical, Leaf, Shield } from "lucide-react"
import { ScrollBlurText } from "./scroll-blur-text"

const stats = [
  { icon: Dumbbell, value: "25g", label: "Protein per serving" },
  { icon: Leaf, value: "100%", label: "Real peanuts" },
  { icon: Shield, value: "0", label: "Palm oil" },
  { icon: FlaskConical, value: "3", label: "Lab-tested batches" },
]
...
const principles = [
  {
    ...
    description:
      "We start with roasted peanuts and clean flavor systems, then keep the label short, honest, and easy to trust.",
  },
  {
    number: "02",
    title: "Performance macros",
    description: "Every jar is designed around protein, satisfying texture, and steady energy for training and daily discipline.",
  },
  {
    number: "03",
    title: "Freshly crafted",
    description: "Small-batch quality checks help protect taste, consistency, and the premium experience from first scoop to last.",
  },
]
...
export function ScienceSection() {
  ...
  const formatValue = (originalValue: string, animatedValue: number | undefined) => {
    ...
    if (originalValue.includes("g")) return `${animatedValue}g`
    ...
    <section ref={sectionRef} id="science" className="py-24 lg:py-32 bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <ScrollBlurText
            text="Natural ingredients to daily energy"
          ...
          <p className="reveal opacity-0 animation-delay-400 text-lg text-primary-foreground/80 max-w-2xl mx-auto leading-relaxed">
            Sorevia tells a simple story: real peanuts become clean energy, clean energy powers training, and training builds a healthier lifestyle.
          </p>
        </div>
