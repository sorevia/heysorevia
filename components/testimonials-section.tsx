...
const testimonials = [
  {
    quote:
      "The Classic Crunch became my post-gym staple. It tastes premium, keeps me full, and the macros make sense.",
    author: "Aarav M.",
    role: "Strength coach",
  ...
  {
    quote:
      "Our members love the gym packs. Clean ingredients, strong flavor, and a brand that feels serious about fitness.",
    author: "Nisha R.",
    role: "Gym owner",
    avatar: "/placeholder.svg?height=80&width=80",
  },
  {
    quote:
      "I use Sorevia in oats and smoothies before work. It makes healthy eating feel less like effort and more like a ritual.",
    author: "Kabir S.",
    role: "Customer for 6 months",
    avatar: "/placeholder.svg?height=80&width=80",
  },
  {
    quote: "The cocoa jar feels like dessert without wrecking my plan. That is exactly what I needed.",
    author: "Meera V.",
    role: "Fitness enthusiast",
    avatar: "/placeholder.svg?height=80&width=80",
  },
  {
    quote: "The subscription is dangerously convenient. Fresh jars show up before I run out.",
    author: "Dev P.",
    ...
    <section ref={sectionRef} id="temoignages" className="py-24 bg-background overflow-hidden lg:py-32 lg:pb-0">
      ...
      <div className="w-full">
        <div className="text-center mb-16 lg:mb-20 px-6">
          ...
          <ScrollBlurText
            text="Loved by athletes and healthy snackers"
